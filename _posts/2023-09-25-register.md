...
canonical_url: 'https://tggsearch.gtihub.io/docs/register.html'
categories: [ telegram ]
pin: true
---
...
看不懂的可以看图片教程
![注册教程3](https://cdn.jsdelivr.net/gh/tggsearch/tggsearch.org/assets/img/android-register.webp)
### iOS（苹果）
#### 苹果推荐方法
可以前往这里购买
...
看不懂的可以看图片教程
![注册教程4](https://cdn.jsdelivr.net/gh/tggsearch/tggsearch.org/assets/img/ios-register.webp)
## 电报飞机应用下载
### Android
首先打开我们上面的梯子
