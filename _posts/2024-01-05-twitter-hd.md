...
<div align=center>
    <img alt="twitter-hd-setting" src="https://cdn.jsdelivr.net/gh/tggsearch/tggsearch.github.io/assets/img/twitter-hd-setting.webp" class="page-img" width="70%"/>
</div>

第四步：在数据使用情况里面，把流量节省程序关闭，如下面这样就可以了。

<div align=center>
    <img alt="twitter-hd-high" src="https://cdn.jsdelivr.net/gh/tggsearch/tggsearch.github.io/assets/img/twitter-hd-high.webp" class="page-img" width="70%"/>
</div>
...
<div align=center>
    <img alt="twitter-app-hd-config" src="https://cdn.jsdelivr.net/gh/tggsearch/tggsearch.github.io/assets/img/twitter-app-hd-config.webp" class="page-img" width="50%"/>
</div>

第二步：在设置里面找到 <b>辅助功能、显示和语言</b>

<div align=center>
    <img alt="twitter-app-hd-setting" src="https://cdn.jsdelivr.net/gh/tggsearch/tggsearch.github.io/assets/img/twitter-app-hd-setting.webp" class="page-img" width="50%"/>
</div>  
