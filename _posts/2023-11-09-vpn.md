...
canonical_url: 'https://tggsearch.gtihub.io/docs/vpn.html'
categories: [ account ]
pin: true
---
...
看不懂的可以看图片教程
![注册教程整体](https://cdn.jsdelivr.net/gh/tggsearch/tggsearch.org/assets/img/android-register.webp)
### iOS（苹果）
#### 苹果推荐方法
可以前往这里购买
...
### 便宜稳定，优质加速器（50块一年，优惠券betrys可以五折优惠）（推荐使用）
[红杏加速器](./302.html?target=https://hongxingdl.com/web/#/login?code=WjjqTnEn)
