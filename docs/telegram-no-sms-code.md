---
layout: default
title: 电报 纸飞机 telegram 收不到验证码 （华为/鸿蒙系统也可解决）
description: 电报 telegram 收不到验证码情况非常多种，sms 收不到验证码，发送的是设备码 device code 是怎么回事，华为鸿蒙系统又是什么问题，每一种都是可以解决的，你可以先对照下面的进行分析，判断自己到底是哪里有问题。
...
### 排查流程图
<div align=center>
    <img alt="telegram no sms code" src="https://cdn.jsdelivr.net/gh/tggsearch/tggSearch.github.io/assets/img/telegram-no-sms-code.webp" class="page-img" width="70%"/>
</div>
...
### 是否是官网最新版本
telegram 收不到短信验证码，第二个原因就是你用的是非官方版本。是否最新电报版本，电报有些旧版本或者非官方会导致无法发送验证码，因此你要确认是不是最新版本，怎么确认呢，安卓可以用科学上网前往官网，如果不知道哪里是官网，可以前往首页查看，也有安卓版本[安卓版本以及官网首页地址](https://tggsearch.github.io/telegram.html)，苹果直接前往appstore查看确认。
